    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Gerencie suas contas a receber e clientes</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="relative md:col-span-2">
          ...
          <input
            type="text"
            placeholder="Buscar por cliente, descrição ou número da fatura..."
            value={search}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors shadow-sm p-4">
          <p className="text-gray-500 text-sm">Recebidas no Mês</p>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="text-left px-6 py-3 text-sm font-semibold text-gray-600">Fatura</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredRecords.map((record) => (
                  <tr key={record.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 text-sm text-gray-900 font-medium">{record.customer_name}</td>
                    <td className="px-6 py-4 text-sm text-gray-500 font-mono">{record.invoice_number || '-'}</td>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-2xl font-semibold tracking-tight text-gray-900">Nova Conta a Receber</h2>
              <button
                onClick={() => setShowModal(false)}
